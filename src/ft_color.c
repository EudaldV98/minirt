...
/*   Updated: 2020/01/10 16:59:24 by jvaquer          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_set_ambience_intensity(t_vect3 *intensity, t_vect3 *ambience)
{
	...
	intensity->x = INTENSITY * g_data->li->ratio * (g_data->li->color.x / COLOR_MAX);
	intensity->y = INTENSITY * g_data->li->ratio * (g_data->li->color.y / COLOR_MAX);
	intensity->z = INTENSITY * g_data->li->ratio * (g_data->li->color.z / COLOR_MAX);
	return (1);
}
