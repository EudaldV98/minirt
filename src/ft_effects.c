...
/*   Updated: 2020/01/10 16:59:37 by jvaquer          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	if (g_data->ratio_tran)
	{
		...
		if (radical > 0)
		{
			...
			tmp = ft_vec_mult_scalar(ft_vec_diff(ray.dir, ft_vec_mult_scalar(n_tran,
					ft_dot_product(ray.dir, n_tran))), (n1 / n2));
			aux_dir = ft_vec_mult_scalar(n_tran, sqrt(radical));
