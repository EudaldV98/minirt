...
/*   Updated: 2020/01/23 23:35:44 by jvaquer          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    ft_for_each_obj_2(t_ray ray, t_vect3 *p, t_vect3 *n, t_vect3 *vec_tmp)
{
	double tmp;
...
void	ft_for_each_obj_3(t_ray ray, t_vect3 *p, t_vect3 *n, t_vect3 *vec_tmp)
{
	double tmp;
