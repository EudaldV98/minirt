...
/*   Updated: 2020/01/16 22:45:59 by janeudaldva      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const double		ft_intersection_ray_sp(const t_ray ray, t_sphere *sp, t_vect3 *p, t_vect3 *n);
const double		ft_for_each_sphere(const t_ray ray, t_vect3 *p, t_vect3 *n);
double				ft_intersection_ray_pl(const t_ray ray, t_plane *pl, t_vect3 *p, t_vect3 *n);
void				ft_draw();
int					ft_intersection_ray_cy(const t_ray ray, t_cylinder *cy, t_vect3 *p, t_vect3 *n);
